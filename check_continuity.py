...
p.add_argument('--baseline',default='resource-baseline.json')
a=p.parse_args()
root=Path(__file__).with_name('evidence')
def read(name):return json.loads((root/name).read_text())
baseline=read(a.baseline);resources=read(a.resources)
...
print(json.dumps({'profile':baseline['profile'],'source_files':[a.before,a.after,a.resources,a.baseline],
